...
source(file.path("functions","Stan_models.R"))
source(file.path("functions","BMD_functions.R"))
...
# Load data sets
datasets_dich<-read.csv("ExampleData.csv",header=TRUE)
...
mod.summary <- round(mod.summary * 1000, digits=0)
...
log.parms <- data.frame(row.names=c("Dataset","Model","Par1","Par2","Par3","Par4"))
...
pro.parms <- data.frame(row.names=c("Dataset","Model","Par1","Par2","Par3","Par4"))
...
wei.parms <- data.frame(row.names=c("Dataset","Model","Par1","Par2","Par3","Par4"))
...
ms2.parms <- data.frame(row.names=c("Dataset","Model","Par1","Par2","Par3","Par4"))
...
llog.parms <- data.frame(row.names=c("Dataset","Model","Par1","Par2","Par3","Par4"))
...
lpro.parms <- data.frame(row.names=c("Dataset","Model","Par1","Par2","Par3","Par4"))
...
dh.parms <- data.frame(row.names=c("Dataset","Model","Par1","Par2","Par3","Par4"))
...
total.data <- total.data[c(3,4,1,2,5,6)]
