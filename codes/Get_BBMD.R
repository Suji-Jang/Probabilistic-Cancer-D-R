...
##### Save output matrix and MCMC samples #####
fwrite(as.data.frame(output.mtx),file.path(bmdfolder,"Summary_Output_data_test.csv"),row.names = TRUE)

mcmcfolder <- "BMD-data/BBMD-MCMC-Samples"
write.csv(output.par.dh,"MCMC_Sample_dh_data.csv")

fwrite(as.data.frame(output.par.ql),file.path(mcmcfolder,"MCMC_Sample_ql_data.csv"),row.names = TRUE)
fwrite(as.data.frame(output.par.log),file.path(mcmcfolder,"MCMC_Sample_log_data.csv"),row.names = TRUE)
fwrite(as.data.frame(output.par.pro),file.path(mcmcfolder,"MCMC_Sample_pro_data.csv"),row.names = TRUE)
fwrite(as.data.frame(output.par.wei),file.path(mcmcfolder,"MCMC_Sample_wei_data.csv"),row.names = TRUE)
fwrite(as.data.frame(output.par.ms2),file.path(mcmcfolder,"MCMC_Sample_ms2_data.csv"),row.names = TRUE)
fwrite(as.data.frame(output.par.llog),file.path(mcmcfolder,"MCMC_Sample_llog_data.csv"),row.names = TRUE)
fwrite(as.data.frame(output.par.lpro),file.path(mcmcfolder,"MCMC_Sample_lpro_data.csv"),row.names = TRUE)
fwrite(as.data.frame(output.par.dh),file.path(mcmcfolder,"MCMC_Sample_dh_data.csv"),row.names = TRUE)
...
fwrite(total.data,file.path(bmdfolder,"Sample_paramaters.csv"))
